...
\author{
\IEEEauthorblockN{Sudip Adhikari\textsuperscript{1}\thanks{Coursework submission for module \textbf{STW7072CEM Machine Learning}, M.Sc.\ Computer Engineering, Softwarica College of IT \& E-Commerce in collaboration with Coventry University. Student ID: 250578.}}
\IEEEauthorblockA{
...
The complete source code, LaTeX sources, generated figures, per-model result files, and a Jupyter notebook reproducing every experiment are publicly available at:
\begin{center}
\url{https://github.com/SudipAdh/NETWORK-INTRUSION-DETECTION}
\end{center}
The repository includes a README with download links for NSL-KDD and a step-by-step run script. All randomness is seeded with \texttt{RANDOM\_SEED = 42}; results in this paper are reproducible bit-for-bit on a Python 3.13 environment with the package versions pinned in \texttt{requirements.txt}.
