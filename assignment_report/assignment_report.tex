...
\fancyhead[R]{Machine Learning -- NID Project}
...
\label{sec:repo}
All code, LaTeX sources for this report and the accompanying research paper, generated figures, and per-model result files are published in a public GitHub repository:
\begin{center}
\url{https://github.com/SudipAdh/NETWORK-INTRUSION-DETECTION}
\end{center}
The repository mirrors the layout described in this report (\texttt{src/}, \texttt{figures/}, \texttt{results/}, \texttt{assignment\_report/}, \texttt{research\_paper/}). The NSL-KDD dataset itself is not redistributed and must be downloaded separately --- the README documents the canonical Kaggle and University of New Brunswick mirrors.
